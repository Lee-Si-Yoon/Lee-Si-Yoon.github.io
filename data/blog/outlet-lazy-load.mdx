...
![outlet-1](/static/images/outlet-lazy-load/outlet-lazy-load-1.png)
...
![outlet-2](/static/images/outlet-lazy-load/outlet-lazy-load-2.png)
...
![outlet-3](/static/images/outlet-lazy-load/outlet-lazy-load-3.png)
Outlet을 통해서 Nested UI를 구성했습니다. 그랬더니

![outlet-4](/static/images/outlet-lazy-load/outlet-lazy-load-4.png)
SidebarLayout은 1회 렌더링되고

![outlet-5](/static/images/outlet-lazy-load/outlet-lazy-load-5.png)
...
![outlet-8](/static/images/outlet-lazy-load/outlet-lazy-load-8.png)
